...
var _photoDevicePng = require("./images/photo-device.png");
var _photoDevicePngDefault = parcelHelpers.interopDefault(_photoDevicePng);
var _photoDataPlatePng = require("./images/photo_data_plate.png");
var _photoDataPlatePngDefault = parcelHelpers.interopDefault(_photoDataPlatePng);
const photosToRender = [
    {
        title: 'Photo_device',
        src: (0, _photoDevicePngDefault.default)
    },
    {
        title: 'Photo_data_plate',
        src: (0, _photoDataPlatePngDefault.default)
    }
];
const fields = [
    {
    ...
    {
        label: 'Devise P/N',
        value: 'NP-P401W / NP23LP+'
    },
    {
        label: 'Dev. Type',
        value: '2013,4000,1280,16:10,LCD'
    },
    {
        label: 'RNK',
        value: '237'
...
function getProductFormData() {
    ...
    const fields = Array.from(form.querySelectorAll('.field')).map((field)=>{
        ...
        const input = field.querySelector('.field__value');
    ...
    const photos = Array.from(form.querySelectorAll('.product-edit__photos img')).map((img)=>({
            src: img.src,
            alt: img.alt
        }));
    return {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","./images/photo_data_plate.png":"5x7xD","./images/photo-device.png":"gtoLv"}],"jnFvT":[function(require,module,exports,__globalThis) {
...
},{}],"5x7xD":[function() {},{}],"gtoLv":[function() {},{}]},["klwky","8Ekvk"], "8Ekvk", "parcelRequire9910", {})

//# sourceMappingURL=product-edit-window.0f5c217b.js.map
